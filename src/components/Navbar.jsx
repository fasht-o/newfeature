...
const Navbar = () => {
  ...
  return (
    <div className="absolute top-0 left-0 w-full z-10">
      <div className="container mx-auto flex md: justify-between items-center py-4 px-6 md:px-20 lg:px-32 bg-transparent">
        ...
        <div
          className={`md:hidden ${
            showMobileMenu ? "fixed w-full" : "h-0 w-0 p-0 m-0"
